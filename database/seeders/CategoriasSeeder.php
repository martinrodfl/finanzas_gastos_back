...
class CategoriasSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $patrones = [
            ...
            'Comercio: DISCO N? 7'            => 'Alimentacion/Supermercado',
            'Comercio: DISCO NE 7'            => 'Alimentacion/Supermercado',
            'Comercio: TIENDA INGLESA 6'      => 'Alimentacion/Supermercado',
            'Comercio: FROG'                  => 'Alimentacion/Supermercado',
            'Comercio: SBARRO'                => 'Alimentacion/Supermercado',
